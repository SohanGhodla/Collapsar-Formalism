...
# --- To load a single model for testing -----
# import pandas as pd
...
while t < tmax:
    ...
    Mbhdot =  u_t(M_, Risco, a_) * Mdotacc * (Rt/Rd)**s_PL #(1 - sqrt(2*Rg/(3*Risco))) * Mdotacc * (Rt/Rd)**s_PL  
    ...
    # --- ends up in the hole ----
    Jbhdot =  u_phi(M_, Risco, a_) * Mdotacc * (Rt/Rd)**s_PL  #j_over_crg(abh, Risco) * Rg * c * Mbhdot
    ...
    Lacc =  eta_acc * Mdotacc * (Rt/Rd)**s_PL * c**2
